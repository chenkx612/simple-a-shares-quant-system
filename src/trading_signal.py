from .config import ASSET_CODES, SMART_M, SMART_N, SMART_K, CORR_THRESHOLD, STOP_LOSS_M, STOP_LOSS_N, STOP_LOSS_K, STOP_LOSS_CORR_THRESHOLD, STOP_LOSS_PCT
from .data_loader import update_all_data
from .backtest import BacktestEngine
from .strategy import SmartRotationStrategy, StopLossRotationStrategy
import pandas as pd
...
def get_trading_signal(strategy_type='smart_rotation', **kwargs):
    ...
    Args:
        strategy_type (str): 'smart_rotation' or 'stop_loss_rotation'
